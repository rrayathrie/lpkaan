...
with try_expander('Text'):
    plot_title = 'TABEL PERIODIK SEDERHANA'
    plot_title = st.text_area('Title', value=plot_title, max_chars=100)

    plot_fonts = ['Georgia','Times'] #,'New Baskerville','Arial','century gothic','Bodoni MT', 'Lucida Sans Unicode']
...
with try_expander('Trademark'):
    trademark_tag = st.text_input('Trademark', value="", max_chars=100)
